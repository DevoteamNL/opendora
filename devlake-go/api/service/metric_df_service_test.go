...
func TestMetricDfService_ServeRequest(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			params:         ServiceParameters{TypeQuery: "df_average", Aggregation: "weekly", Project: "", To: 0, From: 0},
			mockClient:     sql_client.MockClient{MockDeploymentsDataMap: dataMockMap},
			expectResponse: models.MetricResponse{Aggregation: "weekly", DataPoints: exampleAverageWeeklyDataPoints},
			expectError:    "",
		},
		{
			...
			params:         ServiceParameters{TypeQuery: "df_average", Aggregation: "monthly", Project: "", To: 0, From: 0},
			mockClient:     sql_client.MockClient{MockDeploymentsDataMap: dataMockMap},
			expectResponse: models.MetricResponse{Aggregation: "monthly", DataPoints: exampleAverageMonthlyDataPoints},
			expectError:    "",
		},
		{
			...
			params:         ServiceParameters{TypeQuery: "df_average", Aggregation: "quarterly", Project: "", To: 0, From: 0},
			mockClient:     sql_client.MockClient{MockDeploymentsDataMap: dataMockMap},
			expectResponse: models.MetricResponse{Aggregation: "quarterly", DataPoints: exampleAverageQuarterlyDataPoints},
			expectError:    "",
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			dfCountService := MetricDfService{Client: tt.mockClient}
			...
			if !reflect.DeepEqual(got, tt.expectResponse) {
				t.Errorf("MetricDfService.ServeRequest() = %v, want %v", got, tt.expectResponse)
			}
		})
	}
}
